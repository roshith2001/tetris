document.addEventListener('DOMContentLoaded', () => {
    ...
    const upNextTetrominoes = [
        [1, dispalyWidth+1, dispalyWidth*2+1, 2],
        [0, dispalyWidth, dispalyWidth+1, dispalyWidth*2+1], 
        [0, 1, dispalyWidth, dispalyWidth+1], 
        [1, dispalyWidth+1, dispalyWidth*2+1, dispalyWidth*3+1]
    ];
